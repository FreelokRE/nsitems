...
ITEM.desc = "<color=0,255,0>Requires a Strength level of 7 to equip. This baseball bat is a member of the MEDIUM weapons class.</color> A wooden slugger, with two large circular saws attatched to the sides with duct tape and heavy adhesive."
